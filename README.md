...
| :---: | :---: | :---: |
| ![Dogi](assets/images/dogi.png) | ![Raebi](assets/images/raebi.png) | ![Caeti](assets/images/caeti.png) |
...
### 2026.04.23
- **admin.html**:
    - 천문대 및 레이더/신호 요소 위치 조정 (우측 이동)으로 시인성 개선.
    - 미션 안내 단계(1.2.3.4) 레이아웃 최적화 및 4단계 안내 문구 추가.
    - 1920x1080 해상도에 맞게 세로 배치 및 여백 최적화.
- **index.html**:
    - 해독 완료 인증서 내 칭찬 문구 업데이트 (체험부스 안내 추가).
    - 인증서 날짜 옆에 현재 시간(시:분)이 표시되도록 개선.
